...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebApplication1AGRO.Model.Offers", b =>
            {
                b.HasOne("WebApplication1AGRO.Model.ProductDetails", "ProdDeta")
                    .WithMany()
                    .HasForeignKey("ProdDeta_id1")
                    .OnDelete(DeleteBehavior.Cascade)
                    .IsRequired();

                b.Navigation("ProdDeta");
            });

            modelBuilder.Entity("WebApplication1AGRO.Model.ProductDetails", b =>
            {
                b.HasOne("WebApplication1AGRO.Model.Collections", "CollectionPoint")
                    .WithMany()
                    .HasForeignKey("CollectionPoint_id1")
                    .OnDelete(DeleteBehavior.Cascade)
                    .IsRequired();

                b.HasOne("WebApplication1AGRO.Model.Products", "Product")
                    .WithMany()
                    .HasForeignKey("Product_id1")
                    .OnDelete(DeleteBehavior.Cascade)
                    .IsRequired();

                b.HasOne("WebApplication1AGRO.Model.Users", "User")
                    .WithMany()
            ...
            modelBuilder.Entity("WebApplication1AGRO.Model.Products", b =>
            {
                b.HasOne("WebApplication1AGRO.Model.ProductCategories", "Category")
                    .WithMany()
            ...
            modelBuilder.Entity("WebApplication1AGRO.Model.BillDetails", b =>
            {
                b.HasOne("WebApplication1AGRO.Model.Bills", "Bill")
                    .WithMany()
            ...
            modelBuilder.Entity("WebApplication1AGRO.Model.Contacs", b =>
            {
                b.HasOne("WebApplication1AGRO.Model.DataTypes", "DataType")
                    .WithMany()
